...
type AzureServiceBusSubscriptionClient interface {
...
func NewClient(defaultSubscriptionID string) AzureServiceBusSubscriptionClient {
...
func (c *servicebusClient) GetAzureMetric(azMetricRequest AzureMetricRequest) (AzureMetricResponse, error) {
