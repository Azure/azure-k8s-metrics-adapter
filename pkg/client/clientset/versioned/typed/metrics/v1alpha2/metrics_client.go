...
func NewForConfig(c *rest.Config) (*AzureV1alpha2Client, error) {
	...
	return &AzureV1alpha2Client{client}, nil
}

// NewForConfigOrDie creates a new AzureV1alpha2Client for the given config and
...
func New(c rest.Interface) *AzureV1alpha2Client {
	return &AzureV1alpha2Client{c}
}
