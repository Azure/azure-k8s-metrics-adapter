...
func newExternalMetrics(c *AzureV1alpha2Client, namespace string) *externalMetrics {
...
func (c *externalMetrics) Get(name string, options v1.GetOptions) (result *v1alpha2.ExternalMetric, err error) {
	result = &v1alpha2.ExternalMetric{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *externalMetrics) List(opts v1.ListOptions) (result *v1alpha2.ExternalMetricList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ExternalMetricList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("externalmetrics").
...
func (c *externalMetrics) Create(externalMetric *v1alpha2.ExternalMetric) (result *v1alpha2.ExternalMetric, err error) {
	result = &v1alpha2.ExternalMetric{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("externalmetrics").
...
func (c *externalMetrics) Update(externalMetric *v1alpha2.ExternalMetric) (result *v1alpha2.ExternalMetric, err error) {
	result = &v1alpha2.ExternalMetric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("externalmetrics").
