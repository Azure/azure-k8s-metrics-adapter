...
func newCustomMetrics(c *AzureV1alpha2Client, namespace string) *customMetrics {
...
func (c *customMetrics) Get(name string, options v1.GetOptions) (result *v1alpha2.CustomMetric, err error) {
	result = &v1alpha2.CustomMetric{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customMetrics) Create(customMetric *v1alpha2.CustomMetric) (result *v1alpha2.CustomMetric, err error) {
	result = &v1alpha2.CustomMetric{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("custommetrics").
...
func (c *customMetrics) Update(customMetric *v1alpha2.CustomMetric) (result *v1alpha2.CustomMetric, err error) {
	result = &v1alpha2.CustomMetric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("custommetrics").
