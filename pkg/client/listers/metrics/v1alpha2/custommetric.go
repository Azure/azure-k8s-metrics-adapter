...
// List lists all CustomMetrics in the indexer.
func (s *customMetricLister) List(selector labels.Selector) (ret []*v1alpha2.CustomMetric, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.CustomMetric))
	})
	return ret, err
}
...
// List lists all CustomMetrics in the indexer for a given namespace.
func (s customMetricNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.CustomMetric, err error) {
...
// Get retrieves the CustomMetric from the indexer for a given namespace and name.
func (s customMetricNamespaceLister) Get(name string) (*v1alpha2.CustomMetric, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("custommetric"), name)
	}
	return obj.(*v1alpha2.CustomMetric), nil
}
