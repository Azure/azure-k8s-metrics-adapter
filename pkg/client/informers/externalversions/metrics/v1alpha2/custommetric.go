	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AzureV1alpha2().CustomMetrics(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AzureV1alpha2().CustomMetrics(namespace).Watch(options)
			},
		},
		&metricsv1alpha2.CustomMetric{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *customMetricInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&metricsv1alpha2.CustomMetric{}, f.defaultInformer)
}

func (f *customMetricInformer) Lister() v1alpha2.CustomMetricLister {
	return v1alpha2.NewCustomMetricLister(f.Informer().GetIndexer())
}
