...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalMetricsList) DeepCopyInto(out *ExternalMetricsList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalMetricsList.
func (in *ExternalMetricsList) DeepCopy() *ExternalMetricsList {
	if in == nil {
		return nil
	}
	out := new(ExternalMetricsList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ExternalMetricsList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
